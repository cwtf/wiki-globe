...
| Planets | Mercury, Venus, Mars, Jupiter, Saturn, Uranus, Neptune, and Pluto use live astronomy-engine geocentric positions, IAU rotation parameters, labeled sky dots, Mars-style scaled proxy transitions, and body-specific Wikidata/Wikipedia surface markers | Sparse bodies can legitimately show `LIVE 0` when Wikidata has no mapped articles |
